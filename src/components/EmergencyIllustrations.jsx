...
export const CardiacIllustration = ({ step }) => {
  if (step === 1) return (
    <svg viewBox={vb} style={S}>
      <defs>
...
export const TraumaIllustration = ({ step }) => {
  if (step === 1) return (
    <svg viewBox={vb} style={S}>
      <defs>
...
export const UnconsciousIllustration = ({ step }) => {
  if (step === 1) return (
    <svg viewBox={vb} style={S}>
      <defs>
  ...
  if (step === 3) return (
    <svg viewBox={vb} style={S}>
      ...
      <text x="54" y="72" fontSize="26" fill="#38bdf8" fontWeight="900">78</text>
      ...
      <polyline points="36,122 50,122 56,100 62,144 68,100 74,122 92,122 98,108 104,136 110,122 130,122 136,106 142,122 162,122 168,108 174,122 194,122" fill="none" stroke="#38bdf8" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"/>
...
export const RespiratoryIllustration = ({ step }) => {
  if (step === 1) return (
    <svg viewBox={vb} style={S}>
      <defs>
      ...
      <path d="M84 52 Q110 36 136 52" fill="none" stroke="#2dd4bf" strokeWidth="2.5" strokeLinecap="round"/>
