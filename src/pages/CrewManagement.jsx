...
// ─── 이미지 자산 매핑 (Vite) ───
const getPhoto = (num) => new URL(`../assets/photo/${num}.png`, import.meta.url).href

const INITIAL_CREW = [
  { id: 'S26-001', name: '이선장', age: 52, role: '선장', dept: '항해부', blood: 'O+', chronic: '고혈압', allergies: '없음', contact: '010-2600-0001', emergency: '010-1234-5678 (배우자)', avatar: getPhoto(1), isEmergency: false, height: 175, weight: 78, boardingDate: '2024-01-10', location: '브릿지', pastHistory: '2020년 맹장 수술', dob: '1974-05-12', gender: '남', lastMed: '암로디핀 5mg', note: '혈압 관리 주의' },
  { id: 'S26-002', name: '김항해', age: 45, role: '1등 항해사', dept: '항해부', blood: 'A+', chronic: '없음', allergies: '페니실린', contact: '010-2600-0002', emergency: '010-9876-5432 (부친)', avatar: getPhoto(2), isEmergency: false, height: 180, weight: 82, boardingDate: '2024-02-15', location: '데크', pastHistory: '없음', dob: '1981-11-20', gender: '남', lastMed: '없음', note: '특이사항 없음' },
  ...
  { id: 'S26-004', name: '최갑판', age: 41, role: '갑판장', dept: '항해부', blood: 'AB+', chronic: '허리디스크', allergies: '없음', contact: '010-2600-0004', emergency: '010-1122-3344 (배우자)', avatar: getPhoto(4), isEmergency: false, height: 178, weight: 75, boardingDate: '2024-01-20', location: '선수 갑판', pastHistory: '2022년 요추 시술', dob: '1985-03-15', gender: '남', lastMed: '없음', note: '중량물 운반 주의' },
  { id: 'S26-005', name: '정조타', age: 38, role: '조타사', dept: '항해부', blood: 'O-', chronic: '없음', allergies: '조개류', contact: '010-2600-0005', emergency: '010-5566-7788 (동생)', avatar: getPhoto(16), isEmergency: false, height: 170, weight: 68, boardingDate: '2024-04-10', location: '조타실', pastHistory: '없음', dob: '1988-12-22', gender: '남', lastMed: '없음', note: '식품 알레르기 주의' },
  { id: 'S26-006', name: '한통신', age: 43, role: '통신장', dept: '항해부', blood: 'A+', chronic: '비염', allergies: '먼지', contact: '010-2600-0006', emergency: '010-9988-7766 (배우자)', avatar: getPhoto(5), isEmergency: false, height: 174, weight: 72, boardingDate: '2024-02-05', location: '통신실', pastHistory: '없음', dob: '1983-05-30', gender: '남', lastMed: '없음', note: '건강 양호' },
  { id: 'S26-007', name: '강기계', age: 47, role: '1등 기관사', dept: '기관부', blood: 'B-', chronic: '없음', allergies: '벌침', contact: '010-2600-0007', emergency: '010-4455-6677 (누나)', avatar: getPhoto(9), isEmergency: false, height: 179, weight: 80, boardingDate: '2024-03-12', location: '제어실', pastHistory: '없음', dob: '1979-11-18', gender: '남', lastMed: '없음', note: '숙련 정비사' },
  { id: 'S26-008', name: '윤조리', age: 49, role: '조리장', dept: '지원부', blood: 'O+', chronic: '당뇨', allergies: '없음', contact: '010-2600-0008', emergency: '010-6677-8899 (배우자)', avatar: getPhoto(8), isEmergency: false, height: 168, weight: 76, boardingDate: '2024-01-05', location: '조리실', pastHistory: '없음', dob: '1977-09-22', gender: '남', lastMed: '메트포르민', note: '식이 관리 필요' },
  { id: 'S26-009', name: '임전기', age: 35, role: '전기사', dept: '기관부', blood: 'AB-', chronic: '없음', allergies: '없음', contact: '010-2600-0009', emergency: '010-2211-0099 (형)', avatar: getPhoto(7), isEmergency: false, height: 176, weight: 73, boardingDate: '2024-05-20', location: '발전기실', pastHistory: '없음', dob: '1991-03-12', gender: '남', lastMed: '없음', note: '전기 설비 담당' },
  { id: 'S26-010', name: '백보급', age: 32, role: '사무장', dept: '지원부', blood: 'A-', chronic: '없음', allergies: '먼지', contact: '010-2600-0010', emergency: '010-3344-5566 (모친)', avatar: getPhoto(10), isEmergency: false, height: 165, weight: 58, boardingDate: '2024-06-15', location: '사무실', pastHistory: '없음', dob: '1994-07-08', gender: '여', lastMed: '없음', note: '물자 관리 담당' },
  { id: 'S26-011', name: '황갑판', age: 28, role: '갑판원', dept: '항해부', blood: 'B+', chronic: '없음', allergies: '없음', contact: '010-2600-0011', emergency: '010-1100-2233 (동생)', avatar: getPhoto(11), isEmergency: false, height: 182, weight: 85, boardingDate: '2024-07-01', location: '페인트 창고', pastHistory: '없음', dob: '1998-01-25', gender: '남', lastMed: '없음', note: '체력 우수' },
  { id: 'S26-012', name: '서기관', age: 30, role: '3등 기관사', dept: '기관부', blood: 'O+', chronic: '없음', allergies: '땅콩', contact: '010-2600-0012', emergency: '010-5544-3322 (친구)', avatar: getPhoto(12), isEmergency: false, height: 173, weight: 70, boardingDate: '2024-08-10', location: '청정기실', pastHistory: '없음', dob: '1996-12-05', gender: '남', lastMed: '없음', note: '초임 사관' },
  { id: 'S26-013', name: '오항해', age: 26, role: '실습 항해사', dept: '항해부', blood: 'A+', chronic: '없음', allergies: '없음', contact: '010-2600-0013', emergency: '010-7788-9900 (부친)', avatar: getPhoto(13), isEmergency: false, height: 177, weight: 68, boardingDate: '2024-09-01', location: '브릿지', pastHistory: '없음', dob: '2000-04-14', gender: '남', lastMed: '없음', note: '실습 중' },
  { id: 'S26-014', name: '나위생', age: 31, role: '위생원', dept: '지원부', blood: 'B+', chronic: '없음', allergies: '없음', contact: '010-2600-0014', emergency: '010-1122-3344 (언니)', avatar: getPhoto(6), isEmergency: false, height: 162, weight: 52, boardingDate: '2024-04-20', location: '공용실', pastHistory: '없음', dob: '1995-10-30', gender: '여', lastMed: '없음', note: '방역 담당' },
  { id: 'S26-015', name: '고기수', age: 44, role: '기수', dept: '기관부', blood: 'O-', chronic: '치질', allergies: '없음', contact: '010-2600-0015', emergency: '010-9900-1122 (배우자)', avatar: getPhoto(15), isEmergency: false, height: 171, weight: 75, boardingDate: '2024-02-28', location: '워크샵', pastHistory: '없음', dob: '1982-08-12', gender: '남', lastMed: '없음', note: '용접 숙련' },
  { id: 'S26-016', name: '문세탁', age: 33, role: '세탁원', dept: '지원부', blood: 'AB+', chronic: '습진', allergies: '세제', contact: '010-2600-0016', emergency: '010-8899-2233 (모친)', avatar: getPhoto(3), isEmergency: false, height: 164, weight: 60, boardingDate: '2024-06-20', location: '세탁실', pastHistory: '없음', dob: '1993-02-14', gender: '남', lastMed: '연고', note: '장갑 착용 필수' },
]
