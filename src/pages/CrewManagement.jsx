...
const INITIAL_CREW = [
  { id: 'S2026-026', name: '김항해', age: 55, gender: '남', role: '기관장', blood: 'A+', contact: '010-1001-0026', emergency: '양정희 010-2001-0026', embark: '2024-01-10', chronic: '고혈압, 고지혈증', allergies: '아스피린', lastMed: '암로디핀 (08:00)', dob: '1971-08-22', height: 174, weight: 76, location: '기관실 제2엔진', avatar: '/CE.jpeg' },
  { id: 'S2026-088', name: '김태양', age: 29, gender: '남', role: '조리원', blood: 'O+', contact: '010-1001-0088', emergency: '모친 010-2001-0088', embark: '2025-03-15', chronic: '없음', allergies: '조개류', lastMed: '없음', dob: '1997-11-30', height: 182, weight: 70, location: '식당/주방', avatar: 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?auto=format&fit=crop&q=80&w=200' },
