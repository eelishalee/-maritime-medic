...
export default function AIAnalysis({ patient, onNavigate }) {
  ...
  if (scanning && progress < 100) {
    return (
      <div style={{ height:'calc(100vh - 48px)', display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', background:'#050d1a', gap:28 }}>
  ...
  return (
    <div style={{ display:'grid', gridTemplateColumns:'320px 1fr 300px', height:'calc(100vh - 48px)', overflow:'hidden', background:'#050d1a' }}>
...
function TrendingUp({ size=14 }) {
  return <Activity size={size} color="#ff4d6d"/>
}
function TrendingDown({ size=14 }) {
  return <Activity size={size} color="#4fc3f7"/>
}
