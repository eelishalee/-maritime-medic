    ...
    <div style={{ flex: 1, display: 'flex', overflow: 'hidden', height: '100%', position: 'relative', background: '#020408' }}>
      ...
      <section style={{ flex: 1, minWidth: 0, display: 'flex', flexDirection: 'column', overflow: 'hidden', position: 'relative', borderRight: '1px solid rgba(255,255,255,0.05)' }}>
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', background: '#080b12', overflow: 'hidden', position: 'relative' }}>
          <div style={{ padding: '16px 24px', borderBottom: '1px solid rgba(255,255,255,0.05)', background: '#0a0d17', display: 'flex', justifyContent: 'space-between', alignItems: 'center', position: 'relative' }}><div style={{ fontSize: 18, fontWeight: 900, display: 'flex', alignItems: 'center', gap: 10, color: '#e2e8f0' }}><Sparkles size={20} color="#38bdf8" /> MDTS 진단 어시스턴트</div></div>
      ...
      <aside style={{ width: 480, flexShrink: 0, display: 'flex', flexDirection: 'column', background: '#05070a', overflow: 'hidden', position: 'relative', borderLeft: '1px solid rgba(255,255,255,0.05)' }}>
        ...
        {activePatient?.id === 'S26-004' && (
          <div style={{ flexShrink: 0, padding: '0 28px 16px 28px', marginTop: 16 }}><div style={{ width: '100%', height: 240, background: 'rgba(255,255,255,0.02)', borderRadius: 24, border: '1.5px solid rgba(56,189,248,0.2)', overflow: 'hidden', position: 'relative' }}><img src="/assets/test_01.jpg" style={{ width: '100%', height: '100%', objectFit: 'cover' }} alt="Trauma" /></div></div>
        )}
