  ...
  return (
    <div style={{ flex: 1, display: 'flex', overflow: 'hidden', height: '100%', position: 'relative', background: '#020408', cursor: 'default' }}>
      ...
      <aside id="tuto-timeline" style={{ width: 480, flexShrink: 0, display: 'flex', flexDirection: 'column', background: '#05070a', overflow: 'hidden', position: 'relative', borderLeft: '1px solid rgba(255,255,255,0.05)' }}>
        ...
        <div style={{ position: 'absolute', bottom: 116, right: 28, display: 'flex', flexDirection: 'column', gap: 12, zIndex: 11 }}>
          <button onClick={() => startEmergencyAction('CPR')} title="심폐소생술" style={{ width: 64, height: 64, borderRadius: '50%', background: 'linear-gradient(135deg, #f43f5e, #fb7185)', color: '#fff', border: 'none', cursor: 'pointer', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 3, boxShadow: '0 6px 20px rgba(244,63,94,0.45)', fontSize: 10, fontWeight: 800, lineHeight: 1 }}><HeartPulse size={22} /><span>CPR</span></button>
          <button onClick={() => startEmergencyAction('Heimlich')} title="하임리히법" style={{ width: 64, height: 64, borderRadius: '50%', background: 'linear-gradient(135deg, #f97316, #fb923c)', color: '#fff', border: 'none', cursor: 'pointer', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 3, boxShadow: '0 6px 20px rgba(249,115,22,0.45)', fontSize: 10, fontWeight: 800, lineHeight: 1 }}><Wind size={22} /><span>하임리히</span></button>
        </div>
